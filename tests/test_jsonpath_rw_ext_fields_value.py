...
scenarios = [
    ...
    ('sort1_indexed', dict(string='objects[/cow][0].cat',
                            data={'objects': [{'cat': 1, 'cow': 2},
                                                ...
                                                {'cat': 3, 'cow': 3}]},
                            target=2)),
    ('sort2', dict(string=r'objects[\cat]',
                    data={'objects': [{'cat': 2}, {'cat': 1}, {'cat': 3}]},
                    target=[[{'cat': 3}, {'cat': 2}, {'cat': 1}]])),
    ('sort2_indexed', dict(string=r'objects[\cat][-1].cat',
                            data={'objects': [{'cat': 2}, {'cat': 1},
                                                {'cat': 3}]},
                            target=1)),
    ('sort3', dict(string=r'objects[/cow,\cat]',
                    data={'objects': [{'cat': 1, 'cow': 2},
                                        {'cat': 2, 'cow': 1},
                                        {'cat': 3, 'cow': 1},
                                        {'cat': 3, 'cow': 3}]},
                    target=[[{'cat': 3, 'cow': 1},
                            ...
                            {'cat': 1, 'cow': 2},
                            {'cat': 3, 'cow': 3}]])),
    ('sort3_indexed', dict(string=r'objects[/cow,\cat][0].cat',
                            data={'objects': [{'cat': 1, 'cow': 2},
                                                {'cat': 2, 'cow': 1},
                                                {'cat': 3, 'cow': 1},
                                                {'cat': 3, 'cow': 3}]},
